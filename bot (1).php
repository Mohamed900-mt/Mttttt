<?php
//=========التوكن=========//
$token = "7927399702:AAGJD1SEHJc5rm1yvH4fyz9BHi8snqDGRJY"; 
...
#############
$admin = "6666988972";
$Dev = array("$admin","6666988972");
$eri = array("$admin","6666988972");
$idbot = "5534586215";
$sudo = "$admin";
$buy = "kindi3";
$DevUser = "@$buy";
$devchink = "TH3NK";
$userbot = "Taymourrrrr_bot";
$chsource = "$devchink";
############
if ($tc == 'private'){  
@$user = json_decode(file_get_contents("data/user.json"),true);
...
[['text'=>"⋄ ترتيب الاوامر"]],
[['text'=>"⋄ تجربة السورس"],['text'=>"⋄ المطورين الثانويين"]],
[['text'=>"⋄ مسح المطورين الثانويين"]],
],
...
if($text == "مسح المطورين الثانويين"  || $text == "⌯ مسح المطورين الثانويين" and   in_array($from_id,$Dev)){
...
if($text == "⌯ المطورين الثانويين" || $text == "المطورين الثانويين" and   in_array($from_id,$Dev) and $developers_info != NULL and $developers_info != " "){
bot('SendMessage',['chat_id'=>$chat_id,
'text'=>"⋄︙اليك قائمة ⋙ المطورين الثانويين
$list_developers
",'parse_mode'=>'markdown','reply_to_message_id'=>$message->message_id,'disable_web_page_preview'=>true,
]);
}
if($text == "⌯ المطورين الثانويين" || $text == "المطورين الثانويين" and   in_array($from_id,$Dev) and $developers_info == NULL || $developers_info == " "){
bot('SendMessage',['chat_id'=>$chat_id,
'text'=>"
⋄︙ عزيزي ⋙「 [$first_name](tg://user?id=$from_id) 」 
...
if($text == "المنشئين الاساسي" ||  $text == "قائمه المنشئين الاساسي" and $nazarr_info == NULL || $nazarr_info == " " || $nazarr_info == ""){
bot('SendMessage',['chat_id'=>$chat_id,
'text'=>"
⋄︙ عزيزي ⋙「 [$first_name](tg://user?id=$from_id) 」 
...
if($text == "المنشئين" ||  $text == "قائمه المنشئين" and $carloss_info == NULL || $carloss_info == " " || $carloss_info == ""){
bot('SendMessage',['chat_id'=>$chat_id,
'text'=>"⋄︙عزيزي ⋙「 [$first_name](tg://user?id=$from_id) 」 
⋄︙لايوجد منشئ حاليأ
",'parse_mode'=>'markdown','reply_to_message_id'=>$message->message_id,'disable_web_page_preview'=>true,
...
⋄︙العضو ←  [$re_name](tg://user?id=$re_id)
⋄︙تم تنزيله من ← ⤈
~ ( المنشئين الاساسين • المنشئ • المدراء • الادمنيه • المميزين ) ~
",'parse_mode'=>'markdown','reply_to_message_id'=>$message->message_id,'disable_web_page_preview'=>true,
]);
}
}
...
$k = file_get_contents("https://ali-apii.ml/api/zhrfa_Taymour.php?text=".$text);
bot('sendMessage',[
 'chat_id'=>$chat_id,
'text'=>"$k
 ـ────────────
...
⋄︙تغير الايدي ↫ تغ
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
[Source taymour](https://t.me/th3ss)",
'parse_mode'=>"markdown",'reply_to_message_id'=>$message_id,
 ]);
 } 
 #---------------#
